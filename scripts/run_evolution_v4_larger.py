#!/usr/bin/env python3
"""Run GEPA evolution with larger validation set for statistical significance."""
...
# Setup logging
log_file = Path("/home/mila/t/thomas.jiralerspong/LORE/logs/evolution_v4_larger.log")
...
async def main():
    logger.info(f"Starting GEPA Evolution v4 (larger val set) at {datetime.now()}")
    ...
    # Config - LARGER validation set for statistical power
    task_lm = "anthropic/claude-opus-4-5-20251101"
    train_size = 200      # More training samples
    val_size = 150        # Much larger validation set
    test_size = 100       # Held-out test set
    max_metric_calls = 300  # More budget
    ...
    # =========================================================================
    logger.info("="*60)
    logger.info("STARTING GEPA EVOLUTION")
    logger.info("="*60)
    
    output_dir = Path("/home/mila/t/thomas.jiralerspong/LORE/results/ui_evolution_v4")
