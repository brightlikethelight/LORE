#!/bin/bash
#SBATCH --job-name=grpo_conservative
#SBATCH --output=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_conservative_%j.out
#SBATCH --error=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_conservative_%j.err
...
# GRPO Sweep: conservative
# lr=5e-07, beta=0.001, num_gen=8, temp=1.0
...
echo "======================================"
echo "GRPO Sweep: conservative"
echo "======================================"
echo "Job ID: $SLURM_JOB_ID"
echo "Config: lr=5e-07, beta=0.001, num_gen=8, temp=1.0"
...
VAL_SAMPLES=200
MAX_STEPS=200
OUTPUT_DIR="$PROJECT_DIR/results/sweep_conservative_20260122_121415"
...
config.grpo.learning_rate = 5e-07
...
config.wandb.tags = ['sweep', 'conservative', 'lr=5e-07', 'beta=0.001']
