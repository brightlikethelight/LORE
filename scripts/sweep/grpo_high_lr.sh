#!/bin/bash
#SBATCH --job-name=grpo_high_lr
#SBATCH --output=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_high_lr_%j.out
#SBATCH --error=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_high_lr_%j.err
...
# GRPO Sweep: high_lr
# lr=3e-06, beta=0.001, num_gen=8, temp=1.0
...
echo "======================================"
echo "GRPO Sweep: high_lr"
echo "======================================"
echo "Job ID: $SLURM_JOB_ID"
echo "Config: lr=3e-06, beta=0.001, num_gen=8, temp=1.0"
...
VAL_SAMPLES=200
MAX_STEPS=200
OUTPUT_DIR="$PROJECT_DIR/results/sweep_high_lr_20260122_121415"
...
config.wandb.tags = ['sweep', 'high_lr', 'lr=3e-06', 'beta=0.001']
