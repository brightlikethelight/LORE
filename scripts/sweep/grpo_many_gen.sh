#!/bin/bash
#SBATCH --job-name=grpo_many_gen
#SBATCH --output=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_many_gen_%j.out
#SBATCH --error=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_many_gen_%j.err
...
# GRPO Sweep: many_gen
# lr=1e-06, beta=0.001, num_gen=32, temp=1.0
...
echo "======================================"
echo "GRPO Sweep: many_gen"
echo "======================================"
echo "Job ID: $SLURM_JOB_ID"
echo "Config: lr=1e-06, beta=0.001, num_gen=32, temp=1.0"
...
VAL_SAMPLES=200
MAX_STEPS=200
OUTPUT_DIR="$PROJECT_DIR/results/sweep_many_gen_20260122_121415"
...
config.grpo.num_generations = 32
config.grpo.generation_batch_size = 32
...
config.wandb.tags = ['sweep', 'many_gen', 'lr=1e-06', 'beta=0.001']
