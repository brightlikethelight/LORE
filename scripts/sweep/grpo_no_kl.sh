#!/bin/bash
#SBATCH --job-name=grpo_no_kl
#SBATCH --output=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_no_kl_%j.out
#SBATCH --error=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_no_kl_%j.err
...
# GRPO Sweep: no_kl
# lr=1e-06, beta=0.0, num_gen=8, temp=1.0
...
echo "======================================"
echo "GRPO Sweep: no_kl"
echo "======================================"
echo "Job ID: $SLURM_JOB_ID"
echo "Config: lr=1e-06, beta=0.0, num_gen=8, temp=1.0"
...
VAL_SAMPLES=200
MAX_STEPS=200
OUTPUT_DIR="$PROJECT_DIR/results/sweep_no_kl_20260122_121415"
...
config.wandb.tags = ['sweep', 'no_kl', 'lr=1e-06', 'beta=0.0']
