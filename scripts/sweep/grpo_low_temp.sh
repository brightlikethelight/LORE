#!/bin/bash
#SBATCH --job-name=grpo_low_temp
#SBATCH --output=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_low_temp_%j.out
#SBATCH --error=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_low_temp_%j.err
...
# GRPO Sweep: low_temp
# lr=1e-06, beta=0.001, num_gen=8, temp=0.7
...
echo "======================================"
echo "GRPO Sweep: low_temp"
echo "======================================"
echo "Job ID: $SLURM_JOB_ID"
echo "Config: lr=1e-06, beta=0.001, num_gen=8, temp=0.7"
...
VAL_SAMPLES=200
MAX_STEPS=200
OUTPUT_DIR="$PROJECT_DIR/results/sweep_low_temp_20260122_121415"
...
config.wandb.tags = ['sweep', 'low_temp', 'lr=1e-06', 'beta=0.001']
