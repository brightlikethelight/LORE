...
#SBATCH --output=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_qwen1.5b_%j.out
#SBATCH --error=/home/mila/t/thomas.jiralerspong/LORE/logs/grpo_qwen1.5b_%j.err
...
# GRPO Sweep: Qwen2.5-1.5B-Instruct (weaker model)
# model=Qwen2.5-1.5B-Instruct, lr=3e-06, beta=0.001, num_gen=8, temp=1.0
...
echo "======================================"
echo "GRPO Sweep: Qwen2.5-1.5B-Instruct"
echo "======================================"
echo "Job ID: $SLURM_JOB_ID"
echo "Config: model=Qwen2.5-1.5B, lr=3e-06, beta=0.001, num_gen=8, temp=1.0"
...
VAL_SAMPLES=200
MAX_STEPS=200
OUTPUT_DIR="$PROJECT_DIR/results/sweep_qwen1.5b_$(date +%Y%m%d_%H%M%S)"
...
# Use smaller model
config.grpo.model_name = 'Qwen/Qwen2.5-1.5B-Instruct'
...
config.wandb.tags = ['sweep', 'qwen1.5b', 'weak_model', 'lr=3e-06', 'beta=0.001']
